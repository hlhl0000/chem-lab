...
const SIMS = [
  {
    id: "geotime-pre",
    title: "지질 시대의 바다 ① 선캄브리아시대",
    cat: "통합과학",
    path: "geotime-pre/",
    icon: "geotime",
    ready: true,
    desc: "선캄브리아시대 바닷속을 1인칭으로 지나가는 사실적 라이드입니다. 시선을 돌려 세 가지를 봅니다 — 생물이 얼마나 많은가, 몸에 단단한 부분이 있는가(테두리 색), 바닥에 붙어 있는가 헤엄치는가. 바닥에는 이 화면에서 가장 큰 스트로마톨라이트가 서 있습니다.",
    tags: ["지질 시대","선캄브리아시대","스트로마톨라이트","화석","변화와 다양성","1인칭 관찰"]
  },
  {
    id: "geotime-paleo",
    title: "지질 시대의 바다 ② 고생대",
    ...
    icon: "geotime",
    ready: true,
    desc: "고생대 바닷속을 1인칭으로 지나갑니다. 단단한 껍데기를 가진 삼엽충·산호가 나타나고 생물이 훨씬 북적입니다. 선캄브리아 바다와 무엇이 달라졌는지를 같은 세 가지 관찰 포인트로 비교합니다.",
    tags: ["지질 시대","고생대","삼엽충","산호","단단한 껍데기","1인칭 관찰"]
  },
  {
    id: "geotime-meso",
    title: "지질 시대의 바다 ③ 중생대",
    ...
    icon: "geotime",
    ready: true,
    desc: "중생대 바닷속을 1인칭으로 지나갑니다. 나선 껍질의 암모나이트와 목이 긴·물고기 모양 헤엄치는 파충류가 중간 수층을 채웁니다. 하늘을 나는 실루엣은 그리지 않습니다(익룡은 공룡이 아닙니다).",
    tags: ["지질 시대","중생대","암모나이트","해양 파충류","1인칭 관찰"]
  },
  {
    id: "geotime",
    title: "지질 시대의 바다 — 선캄브리아·고생대·중생대(통합판)",
    cat: "통합과학",
    path: "geotime/",
    icon: "geotime",
    ready: true,
